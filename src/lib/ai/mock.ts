...
export const PHRASEBOOKS: Record<ThemeId, Phrasebook> = {
  'historic-fantasy': {
    ...
    items: ['lantern', 'key', 'door', 'tree', 'scroll', 'stranger', 'sword', 'crown', 'candle', 'castle', 'dragon', 'potion'],
  },
  future: {
    ...
    items: ['planet', 'robot', 'rocket', 'satellite', 'airlock', 'stranger', 'eye', 'hourglass'],
  },
  noir: {
    ...
    items: ['stranger', 'revolver', 'telephone', 'streetlamp', 'car', 'letter', 'rain', 'key'],
  },
  pirate: {
    ...
    items: ['ship', 'anchor', 'parrot', 'map', 'cannon', 'lighthouse', 'chest', 'compass'],
  },
  ancient: {
    ...
    items: ['temple', 'amphora', 'owl', 'lyre', 'ship', 'sword', 'crown', 'mountain'],
  },
  dream: {
    ...
    items: ['mirror', 'island', 'butterfly', 'clock', 'moon', 'door', 'staircase', 'bird'],
  },
}
